    ...
    return [
      {
        label: "登录 / 注册",
        key: "login",
        icon: renderIcon("heroicons:arrow-right-on-rectangle"),
      },
    ];
  }
  return [
    { label: "个人中心", key: "profile", icon: renderIcon("heroicons:user") },
    {
      label: "退出登录",
      key: "logout",
      icon: renderIcon("heroicons:arrow-left-on-rectangle"),
    },
  ];
});
  ...
  >
    ...
    >
      <div class="relative w-24 h-24 mb-8">
        <div
          class="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#6692E1] to-[#7FA4E8] animate-pulse"
        ></div>
        <div class="absolute inset-0 flex items-center justify-center">
          <Icon
            name="simple-icons:osu"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div
                class="w-10 h-10 rounded-xl bg-gradient-to-br from-[#6692E1] to-[#7FA4E8] flex items-center justify-center shadow-lg shadow-blue-500/20 shrink-0 z-10"
              >
        ...
        >
          <div class="flex items-center gap-4">
            ...
            <div v-if="isMobile" class="flex items-center gap-2">
              <div
                class="w-8 h-8 rounded-lg bg-gradient-to-br from-[#6692E1] to-[#7FA4E8] flex items-center justify-center shadow-lg shadow-blue-500/20"
              >
              ...
              >
                <template v-if="userProfile.isLoggedIn">
                  ...
                  >
                    ...
                    <div class="flex flex-col overflow-hidden">
                      ...
                      <span
                        ...
                        >ID: #{{ Math.floor(Math.random() * 100000) }}</span
                      >
                    </div>
                  </div>
                  ...
                  <div class="grid grid-cols-2 gap-2">
                    ...
                    >
                      <template #icon><Icon name="heroicons:user" /></template>
                      个人中心
                    </n-button>
                    <n-button secondary class="!rounded-lg">
                      <template #icon
            ...
            >
              ...
              >
                <div class="flex flex-col items-center gap-4">
                  <div
                    class="w-12 h-12 rounded-xl bg-gradient-to-br from-[#6692E1] to-[#7FA4E8] animate-spin shadow-lg flex items-center justify-center"
                  >
                    <Icon name="simple-icons:osu" class="text-white text-2xl" />
                  </div>
                  <span
      ...
      <div class="h-full flex flex-col bg-[var(--bg-layout-sider)]">
        ...
        >
          <div class="flex items-center gap-3 text-[var(--text-main)]">
            <div
              class="w-10 h-10 rounded-xl bg-gradient-to-br from-[#6692E1] to-[#7FA4E8] flex items-center justify-center shadow-lg shadow-blue-500/20 shrink-0"
            >
              <Icon name="simple-icons:osu" class="text-white text-2xl" />
            </div>
